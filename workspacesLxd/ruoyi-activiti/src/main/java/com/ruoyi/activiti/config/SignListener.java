...
//获取流程参数pass，会签人员完成自己的审批任务时会添加流程参数pass，false为拒绝，true为同意
		...
		System.out.println(taskService.getVariable(exId, "pass"));
		System.out.println(runtimeService.getVariable(exId, "pass"));
		boolean pass = (Boolean) taskService.getVariable(exId, "pass");
