...
public class AppNgBase extends BaseEntity {
     ...
     */
    @Excel(name = "材料预算")
    private Long budgetMaterial;

    /**
     * 人工预算
     */
    @Excel(name = "人工预算")
    private Long budgetLabor;
    ...
    public void setBudgetMaterial(Long budgetMaterial) {
        this.budgetMaterial = budgetMaterial;
    }

    public Long getBudgetMaterial() {
        return budgetMaterial;
    }

    public void setBudgetLabor(Long budgetLabor) {
        this.budgetLabor = budgetLabor;
    }

    public Long getBudgetLabor() {
        return budgetLabor;
    }
