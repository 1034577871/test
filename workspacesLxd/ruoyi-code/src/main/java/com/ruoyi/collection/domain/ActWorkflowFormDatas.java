 ...
 * @date 2020-11-02
 */
public class ActWorkflowFormDatas extends BaseEntity
{
    ...
    public ActWorkflowFormDatas() {
    }

    public ActWorkflowFormDatas(String businessKey, ActWorkflowFormDatasDTO actWorkflowFormDataDTO, Task task) {
