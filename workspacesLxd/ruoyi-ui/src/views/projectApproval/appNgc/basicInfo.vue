      ...
      <el-row :gutter="15">
        <el-col :span="6">
          <el-form-item label="项目类别">
            <el-select v-model="formData.projectTypeId" placeholder="请选择" style="width: 100%;" @change="$forceUpdate()">
      ...
      <el-row :gutter="15">
        <el-col :span="6">
          <el-form-item label="建筑物数">
            <el-input-number :style="{ width: '100%' }" v-model="formData.buildingsNumber" :min="0" :step="1"></el-input-number>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="涉及建筑">
            <el-input-number :style="{ width: '100%' }" v-model="formData.buildingsInvolvedNumber" :min="0" :step="1"></el-input-number>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="数字TV数">
            <el-input-number :style="{ width: '100%' }" v-model="formData.digitaltvNumber" :min="0" :step="1"></el-input-number>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="宽带数">
            <el-input-number :style="{ width: '100%' }" v-model="formData.broadbandNumber" :min="0" :step="1"></el-input-number>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="15">
        <el-col :span="6">
          <el-form-item label="材料预算" prop="budgetMaterial">
            <el-input v-model="formData.budgetMaterial" v-on:input="changeNum()"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="人工预算" prop="budgetLabor">
            <el-input v-model="formData.budgetLabor" v-on:input="changeNum()"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
