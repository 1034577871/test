<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" ref="itsmDataTable" :data="contractList" @selection-change="handleSelectionChange" border >
      ...
      <el-table-column label="合同金额" align="center" prop="totalMoney" width="110"/>
      <el-table-column label="已收/已付" align="center" prop="receiveAmount" width="110"/>
      <el-table-column label="未收/未付" align="center" prop="outstandingAmount" width="110"/>
      <el-table-column label="已核销金额" align="center" prop="writeOffAmount" width="110"/>
    </el-table>
...
<script>
import { listContract, getContract, delContract, addContract, updateContract, exportContract, collectionAndPaymentStatistics } from '@/api/contract/contractInfo';
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      collectionAndPaymentStatistics(this.addDateRange(this.queryParams, this.createTime)).then(response => {
