 ...
 * @date 2020-12-11
 */
public class CtBuInvoiceInfoReq extends BaseEntity
{
    ...
    public String getCreateByName1() {
        return createByName1;
    }

    public void setCreateByName1(String createByName1) {
        this.createByName1 = createByName1;
    }

    private String createByName1;

    public String getInstranceId() {
        return instranceId;
    }

    public void setInstranceId(String instranceId) {
        this.instranceId = instranceId;
    }

    private String instranceId;
    ...
    public String getInvoiceAmountTax1() {
        return invoiceAmountTax1;
    }

    public void setInvoiceAmountTax1(String invoiceAmountTax1) {
        this.invoiceAmountTax1 = invoiceAmountTax1;
    }

    public String getInvoiceAmountNtax1() {
        return invoiceAmountNtax1;
    }

    public void setInvoiceAmountNtax1(String invoiceAmountNtax1) {
        this.invoiceAmountNtax1 = invoiceAmountNtax1;
    }

    private String reqUsername;
    private String payerName;
    private String invoiceAmountTax1;
    private String invoiceAmountNtax1;
