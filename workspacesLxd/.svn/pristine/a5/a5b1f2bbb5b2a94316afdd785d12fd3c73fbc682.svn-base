package com.ruoyi.projectApproval.AppNgCompany.mapper;
...
/**
 * 事前审批明细(集客类-涉及分公司)Mapper接口
 *
 * @author ruoyi
 * @date 2021-01-19
 */
public interface CtBuApprovaldtNgCompanyMapper {
    /**
     * 查询事前审批明细(集客类-涉及分公司)
     *
