<template>
  <div ref="approvalInfo">
  <div style="padding: 0 15px;">
    <h2 style="text-align: center;color:#3388ee;">非集客项目事前审批表</h2>
    <el-row :gutter="15">
          ...
          <tbody>
            <tr>
              ...
              <td colspan="3" width="30%" style="text-align: right;">
                <span class="labelX">项目编号</span>
              </td>
              <td colspan="2" width="30%">
                <el-input v-model="formData.appxNgNo" placeholder="项目编号" style="border: none;" :readOnly="true"></el-input>
                <!--                {{ formData.appxNgNo }}-->
              </td>
            </tr>
            <tr>
              ...
              <td colspan="7" style="text-align: left;">
                <el-input v-model="this.proName" placeholder="项目名称" style="border: none;" :readOnly="true"></el-input>
              </td>
            </tr>
            <tr>
              <td colspan="2" style="text-align: right;">
              ...
              <td colspan="2">
                <el-select v-model="this.proType" clearable :disabled="true">
              ...
              <td colspan="2">
                {{ parseTime(formData.applyDate, '{y}-{m}-{d}') }}
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                <el-input readonly="readonly" v-model="formData.tranrevenue" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.trantaxrate" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.tranrevenueno" :disabled="true"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.tranoutput" :disabled="true"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" type="textarea" v-model="formData.tranremarks"></el-input>
              </td>
            </tr>
            <tr>
              <td><span class="labelX">设备收入</span></td>
              <td>
                <el-input readonly="readonly" v-model="formData.devicerevenue" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.devicetaxrate" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.devicerevenueno" :disabled="true"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.deviceoutput" :disabled="true"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" type="textarea" v-model="formData.deviceremarks"></el-input>
              </td>
            </tr>
            <tr>
              <td><span readonly="readonly" class="labelX">技术服务收入</span></td>
              <td>
                <el-input readonly="readonly" v-model="formData.serverevenue" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.servetaxrate" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.serverevenueno" :disabled="true"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.serveoutput" :disabled="true"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" type="textarea" v-model="formData.serveremarks"></el-input>
              </td>
            </tr>
            <tr>
              <td><span class="labelX">工程收入</span></td>
              <td>
                <el-input readonly="readonly" v-model="formData.projectrevenue" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.projecttaxrate" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.projectrevenueno" :disabled="true"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.projectoutput" :disabled="true"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" type="textarea" v-model="formData.projectremarks"></el-input>
              </td>
            </tr>
            <tr>
              <td><span class="labelX">租赁收入</span></td>
              <td>
                <el-input readonly="readonly" v-model="formData.leaserevenue" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.leasetaxrate" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.leaserevenueno" :disabled="true"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.leaseoutput" :disabled="true"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" type="textarea" v-model="formData.leaseremarks"></el-input>
              </td>
            </tr>
            <tr>
              <td><span class="labelX">软件收入</span></td>
              <td>
                <el-input readonly="readonly" v-model="formData.softwarerevenue" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.softwaretaxrate" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.softwarerevenueno" :disabled="true"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.softwareoutput" :disabled="true"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" type="textarea" v-model="formData.softwareremarks"></el-input>
              </td>
            </tr>
            <tr>
              <td><span class="labelX">广告收入</span></td>
              <td>
                <el-input readonly="readonly" v-model="formData.advertrevenue" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.adverttaxrate" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.advertrevenueno" :disabled="true"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.advertoutput" :disabled="true"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" type="textarea" v-model="formData.advertremarks"></el-input>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                <el-input readonly="readonly" v-model="formData.devicecostmoney" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.devicecosttaxrate" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.devicecostmoneyno" :disabled="true"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.devicecostincome" :disabled="true"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" type="textarea" v-model="formData.devicecostremarks"></el-input>
              </td>
            </tr>
            <tr>
              <td><span class="labelX">材料成本</span></td>
              <td>
                <el-input readonly="readonly" v-model="formData.stuffcostmoney" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.stuffcosttaxrate" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.stuffcostmoneyno" :disabled="true"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.stuffcostincome" :disabled="true"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" type="textarea" v-model="formData.stuffcostremarks"></el-input>
              </td>
            </tr>
            <tr>
              <td><span class="labelX">工程转包成本(包工包料)</span></td>
              <td>
                <el-input readonly="readonly" v-model="formData.turncostmoney" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.turncosttaxrate" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.turncostmoneyno" :disabled="true"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.turncostincome" :disabled="true"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" type="textarea" v-model="formData.turncostremarks"></el-input>
              </td>
            </tr>
            <tr>
              <td><span class="labelX">服务费</span></td>
              <td>
                <el-input readonly="readonly" v-model="formData.servecostmoney" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.servecosttaxrate" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.servecostmoneyno" :disabled="true"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.servecostincome" :disabled="true"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" type="textarea" v-model="formData.servecostremarks"></el-input>
              </td>
            </tr>
            <tr>
              <td><span class="labelX">施工费</span></td>
              <td>
                <el-input readonly="readonly" v-model="formData.buildcostmoney" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.buildcosttaxrate" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.buildcostmoneyno" :disabled="true"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.buildcostincome" :disabled="true"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.buildcostremarks" type="textarea"></el-input>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <el-input readonly="readonly" v-model="formData.havedevicemoney" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.havedevicetaxrate" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.havedevicemoneyno" :disabled="true"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.havedeviceincome" :disabled="true"></el-input>
              </td>
              <td rowspan="2">
                <el-input readonly="readonly" v-model="formData.havedeviceremarks" type="textarea"></el-input>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <el-input readonly="readonly" v-model="formData.havelinemoney" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.havelinetaxrate" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.havelinemoneyno" :disabled="true"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.havelineincome" :disabled="true"></el-input>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <el-input readonly="readonly" v-model="formData.upholdcostmoney" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.upholdcosttaxrate" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.upholdcostmoneyno" :disabled="true"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.upholdcostincome" :disabled="true"></el-input>
              </td>
              <td>
                <div style="width: 75%;float: left;">
                  <el-input readonly="readonly" v-model="formData.upholdcostremarks" type="textarea"></el-input>
                </div>
            ...
            <tr v-for="(value, index) in formData.dataList" :key="index">
              <td>
                <el-input readonly="readonly" v-model="value.name" :name="'appMateList[' + index + '].name'" />
              </td>
              <td>
                <el-input readonly="readonly" v-model="value.money" :name="'appMateList[' + index + '].money'" v-on:input="changeNum()" />
              </td>
              <td>
                <el-input readonly="readonly" v-model="value.taxRate" :name="'appMateList[' + index + '].taxRate'" v-on:input="changeNum()" />
              </td>
              <td>
                <el-input readonly="readonly" v-model="value.noTaxMoney" :name="'appMateList[' + index + '].noTaxMoney'" :disabled="true" />
              </td>
              <td>
                <el-input readonly="readonly" v-model="value.incomeMoney" :name="'appMateList[' + index + '].incomeMoney'" v-on:input="changeNum(index)"
                  :disabled="true" />
              </td>
              <td>
                <div style="width: 75%;float: left;">
                  <el-input readonly="readonly" v-model="value.remarks" :name="'appMateList[' + index + '].remarks'" v-on:input="changeNum(index)" />
                </div>
                <!-- <div style="width: 25%;float: right;margin-top: 10px;">
            ...
            <tr>
              ...
              <td>
                <el-input readonly="readonly" v-model="formData.othercostmoney" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.othercosttaxrate" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.othercostmoneyno" :disabled="true"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.othercostincome" :disabled="true"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" type="textarea" v-model="formData.othercostremarks"></el-input>
              </td>
            </tr>
            <tr>
              <td><span class="labelX">垫资利息</span></td>
              <td>
                <el-input readonly="readonly" v-model="formData.interestcostmoney" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.interestcosttaxrate" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.interestcostmoneyno" :disabled="true"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" v-model="formData.interestcostincome" :disabled="true"></el-input>
              </td>
              <td>
                <el-input readonly="readonly" type="textarea" v-model="formData.interestcostremarks"></el-input>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td colspan="2" rowspan="4">
                <span class="labelX title" style="color: #FFA500;">其<br />他<br />费<br />用</span>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <el-input readonly="readonly" type="textarea" v-model="formData.incrementremarks"></el-input>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <el-input readonly="readonly" type="textarea" v-model="formData.attachremarks"></el-input>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <el-input readonly="readonly" type="textarea" v-model="formData.culturebuildremarks"></el-input>
              </td>
            </tr>
            <tr>
              <td colspan="4">
              ...
              <td>
                <el-input readonly="readonly" type="textarea" v-model="formData.estimateprofitremarks"></el-input>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <el-input readonly="readonly" type="textarea" v-model="formData.epmarginremarks"></el-input>
              </td>
            </tr>
          </tbody>
...
<script>
  ...
  export default {
    ...
    created() {
      this.$bus.$on('aaa', (val) => {
        this.formData.stuffcostmoney = val;
        this.changeNum()
      })
      this.$bus.$on('bbb', (val) => {
        this.formData.buildcostmoney = val;
        this.changeNum()
      })
      ...
      if (!this.approvalInfoDate) {
        this.formData = {
          ...
          buildcostremarks: "无产权工程，小规模纳税人税率3%，一般纳税人税率9%，根据施工方情况可修改税率",
          havedevicemoney: null,
          havedevicetaxrate: 13,
          havedevicemoneyno: null,
          havedeviceincome: null,
          havedeviceremarks: "自有产权工程，成本（不含税金额）按折旧计算，按投资形成资产月折旧金额*项目期限，即成本=折旧=设备不含税金额*0.95/折旧年限*服务年份，设备折旧年限8年，线路资产折旧年限15年",
          havelinemoney: null,
          havelinetaxrate: 9,
          ...
          interestcostremarks: "政府采购项目经批准后可以垫资，需计算垫资利息作为项目成本，利率按4.35%计算。其他集客项目原则上不允许垫资。垫资金额   万元，垫资   月，垫资利息=垫资金额*4.35%/12*月份",
          costmoney: null,
          costmoneyno: null,
          costincome: null,
    ...
    methods: {
      ...
      //打印
      print_sp() {
        this.$print(this.$refs.approvalInfo)
      },
    }
  };
</script>
