<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" border ref="financialList"  :data="financialList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="ids" style="text-align: center ;"  prop="ctBuInvoiceInfoVo.ids"   v-if="show"/>
      ...
      <el-table-column label="是否老合同" style="text-align: center ;"  prop="ctBuInvoiceReqVo.isOldCon"  v-if="show"/>
      ...
      <el-table-column label="发票类型" style="text-align: center ;"  prop="ctBuInvoiceReqVo.invoiceType_" :show-overflow-tooltip="true">
      ...
      <el-table-column label="申请金额" style="text-align: center ;"  prop="ctBuInvoiceReqVo.invoiceAmountTax_" />
      ...
      <el-table-column label="开票金额" style="text-align: center ;"  prop="ctBuInvoiceInfoVo.invoiceAmountTaxs" />
      ...
      <el-table-column label="回款时间" style="text-align: center ;" prop="collectionTime" />
        ...
        <el-row >
          ...
          <el-col :span="8">
            ...
            <el-form-item label="项目编号" prop="proNo">
              ...
              <el-input v-model="form.reqId" :readonly="true"   v-if="show"/>
      ...
      handleUpdate(row) {
        ...
        if(id==''){
          const _selectData = this.$refs.financialList.selection;
            ...
            this.isOldCon = _selectData[0].ctBuInvoiceReqVo.isOldCon;
            ...
            this.queryParams.status = 1;
            this.queryParams.ids= _selectData[0].ctBuInvoiceInfoVo.ids;

            listFinancialList(this.queryParams).then(response => {
              this.token = { Authorization: getToken() };
              this.form.reqId = response.rows[0].ctBuInvoiceInfoVo.reqIds;
              ...
              this.open = true;
              this.form.collectionAmount = response.rows[0].ctBuInvoiceInfoVo.invoiceAmountTaxs;
              this.title = "收款单录入";
          ...
          getReceiptInfo(id).then(response => {
            ...
            const _selectDatas = this.$refs.financialList.selection;
            if(_selectDatas.length>1){
              this.msgError("只能选择一条记录");
              return false;
            }
            this.isOldCon = _selectDatas[0].ctBuInvoiceReqVo.isOldCon;
