package com.ruoyi.projectApproval.AppNgConst.mapper;
...
/**
 * 事前审批明细(集客类-施工费情况)Mapper接口
 *
 * @author Mu
 * @date 2020-12-09
 */
public interface AppNgConstMapper {
    ...
    public int deleteAppNgConstByCid(String id);
}
