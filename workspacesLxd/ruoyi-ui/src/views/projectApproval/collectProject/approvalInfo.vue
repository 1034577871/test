...
<script>
  ...
  export default {
    ...
    created() {
      console.log(this.approvalInfoDate);
      findProjectType().then(response => {
        this.proTypeNameList = response.data;
      });

      console.log("xxx:"+this.approvalInfoDate);
