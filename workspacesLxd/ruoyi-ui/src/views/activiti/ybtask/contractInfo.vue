...
<template>
  <div>
     <el-form ref="form" :model="form"  label-width="100px">
          <el-dialog title="合同审核" :visible.sync="modalShow" width="80%" :before-close="modalClose">
            <el-row :gutter="15">
            ...
            <el-row :gutter="15">
              <el-table :data="form.ctBuContractContentList" border>
                ...
                <el-table-column label="项目类型" prop="contentName" header-align="center" align="center">
                </el-table-column>
...
import {
    ...
    export default {
        ...
        methods:{
            init(row){
              this.tableData=[];
              getContract(row.businessKey).then(response => {
                ...
                findFileListByPidPtype(row.businessKey, 3).then(response => {
                  this.contractApprovalFile = response.data;
                });
                findFileListByPidPtype(row.businessKey, 4).then(response => {
