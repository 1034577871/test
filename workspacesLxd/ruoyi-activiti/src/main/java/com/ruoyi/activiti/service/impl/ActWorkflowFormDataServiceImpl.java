...
public class ActWorkflowFormDataServiceImpl implements IActWorkflowFormDataService
{
     ...
     */
    @Override
    public List<ActWorkflowFormData> selectGroupActWorkflowFormDataList(ActWorkflowFormData ActWorkflowFormData)
    {
        List<ActWorkflowFormData> list = actWorkflowFormDataMapper.selectGroupActWorkflowFormDataList(ActWorkflowFormData);
        return list;
    }
    ...
    {
        List<ActWorkflowFormData> list = actWorkflowFormDataMapper.selectActWorkflowFormDataList(ActWorkflowFormData);
        return list;
    }
    ...
    public int insertActWorkflowFormData(ActWorkflowFormData ActWorkflowFormData)
    {
        ...
        if (loginUser != null && loginUser.getUser() != null) {
            ActWorkflowFormData.setCreateBy(loginUser.getUser().getUserId().toString());
            ActWorkflowFormData.setCreateName(loginUser.getUser().getUserName());
        }
