        ...
        <table class="table table-bordered" style="text-align: center;width: 100%;vertical-align:middle;">
          <tbody>
            ...
            <tr>
              ...
              <td>
                <el-input v-model="formData.tranrevenue" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input v-model="formData.trantaxrate" v-on:input="changeNum()"></el-input>
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                <el-input v-model="formData.devicerevenue" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input v-model="formData.devicetaxrate" v-on:input="changeNum()"></el-input>
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                <el-input v-model="formData.serverevenue" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input v-model="formData.servetaxrate" v-on:input="changeNum()"></el-input>
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                <el-input v-model="formData.projectrevenue" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input v-model="formData.projecttaxrate" v-on:input="changeNum()"></el-input>
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                <el-input v-model="formData.leaserevenue" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input v-model="formData.leasetaxrate" v-on:input="changeNum()"></el-input>
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                <el-input v-model="formData.softwarerevenue" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input v-model="formData.softwaretaxrate" v-on:input="changeNum()"></el-input>
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                <el-input v-model="formData.advertrevenue" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input v-model="formData.adverttaxrate" v-on:input="changeNum()"></el-input>
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                <el-input v-model="formData.devicecostmoney" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input v-model="formData.devicecosttaxrate" v-on:input="changeNum()"></el-input>
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                <el-input v-model="formData.stuffcostmoney" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input v-model="formData.stuffcosttaxrate" v-on:input="changeNum()"></el-input>
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                <el-input v-model="formData.turncostmoney" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input v-model="formData.turncosttaxrate" v-on:input="changeNum()"></el-input>
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                <el-input v-model="formData.servecostmoney" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input v-model="formData.servecosttaxrate" v-on:input="changeNum()"></el-input>
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                <el-input v-model="formData.buildcostmoney" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input v-model="formData.buildcosttaxrate" v-on:input="changeNum()"></el-input>
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                <el-input v-model="formData.havedevicemoney" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input v-model="formData.havedevicetaxrate" v-on:input="changeNum()"></el-input>
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                <el-input v-model="formData.havelinemoney" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input v-model="formData.havelinetaxrate" v-on:input="changeNum()"></el-input>
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                <el-input v-model="formData.upholdcostmoney" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input v-model="formData.upholdcosttaxrate" v-on:input="changeNum()"></el-input>
              </td>
              <td>
            ...
            <tr v-for="(value, index) in formData.dataList" :key="index">
              <td>
                <el-input v-model="value.name" :name="'appMateList[' + index + '].name'" />
              </td>
              <td>
                <el-input v-model="value.money" :name="'appMateList[' + index + '].money'" v-on:input="changeNum()" />
              </td>
              <td>
                <el-input v-model="value.taxRate" :name="'appMateList[' + index + '].taxRate'" v-on:input="changeNum()" />
              </td>
              <td>
                <el-input v-model="value.noTaxMoney" :name="'appMateList[' + index + '].noTaxMoney'" :disabled="true" />
              </td>
              <td>
                <el-input v-model="value.incomeMoney" :name="'appMateList[' + index + '].incomeMoney'" v-on:input="changeNum(index)"
                  :disabled="true" />
              </td>
              <td>
                <div style="width: 75%;float: left;">
                  <el-input v-model="value.remarks" :name="'appMateList[' + index + '].remarks'" v-on:input="changeNum(index)" />
                </div>
                <div style="width: 25%;float: right;margin-top: 10px;">
            ...
            <tr>
              ...
              <td>
                <el-input v-model="formData.othercostmoney" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input v-model="formData.othercosttaxrate" v-on:input="changeNum()"></el-input>
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                <el-input v-model="formData.interestcostmoney" v-on:input="changeNum()"></el-input>
              </td>
              <td>
                <el-input v-model="formData.interestcosttaxrate" v-on:input="changeNum()"></el-input>
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                <el-input type="textarea" v-model="formData.estimateprofitremarks"></el-input>
              </td>
            </tr>
  ...
  export default {
    ...
    methods: {
      ...
      removeTodo: function(index) {
        ...
        let ids = this.formData.dataList[index].id;
        console.log(ids)
        if(ids!='' && ids!=null){
          return request({
            url: '/system/list/remove/'+ids,
            methods: 'get'
          }).then(response => {
            this.rowspanNum -= 1;
