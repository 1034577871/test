      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <div v-if="scope.row.status >0">
            ...
            <el-button size="mini" type="text" icon="el-icon-view" @click="examineAndApproves (scope.row)">查看流程图
            </el-button>
    ...
    <el-dialog :title="title" :visible.sync="open" width="80%" append-to-body :rules="rules">
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="项目分类" prop="classification">
              <el-select style="width:100%;" v-model="form.classification" placeholder="请输入项目分类" clearable size="small">
                <el-option v-for="dict in projectSortOptions" :key="dict.dictValue" :label="dict.dictLabel" :value="dict.dictValue" />
              </el-select>
            </el-form-item>
          </el-col>
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="同步资管" prop="isSync" v-show="showIsSync">
              <el-radio-group v-model="form.isSync" size="mini">
                <el-radio-button :label="1">是</el-radio-button>
                <el-radio-button :label="2">否</el-radio-button>
              </el-radio-group>
            </el-form-item>
      ...
      submitForm(number) {
        ...
        this.$refs["form"].validate(valid => {
          if (valid) {
            ...
            // console.log(this.$refs.basicInfo.formData);
            if (this.form.proType == "36e4550f15954fbbadf4dff4f6fc63ea") {
