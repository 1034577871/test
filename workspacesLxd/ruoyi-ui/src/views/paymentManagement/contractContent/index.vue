  ...
  <div class="app-container">
    ...
    <!-- <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['contract:contractContent:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['contract:contractContent:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['contract:contractContent:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="项目类型" prop="contentType">
          <el-select v-model="form.contentType" placeholder="请选择项目类型">
            <el-option label="请选择字典生成" value="" />
          </el-select>
        </el-form-item>
        <el-form-item label="类型税率" prop="contentTaxrate">
          <el-input v-model="form.contentTaxrate" placeholder="请输入类型税率" />
        </el-form-item>
        <el-form-item label="类型名称" prop="contentName">
          <el-input v-model="form.contentName" placeholder="请输入类型名称" />
        </el-form-item>
        <el-form-item label="含税金额" prop="intaxAmount">
          <el-input v-model="form.intaxAmount" placeholder="请输入含税金额" />
        </el-form-item>
        <el-form-item label="不含税金额" prop="extaxAmount">
          <el-input v-model="form.extaxAmount" placeholder="请输入不含税金额" />
        </el-form-item>
...
<script>
import { ticketListContractContent, getContractContent, delContractContent, addContractContent, updateContractContent, exportContractContent } from "@/api/contract/contractContent";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      ticketListContractContent(this.queryParams).then(response => {
