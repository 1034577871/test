...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
	 ...
	 * @Description: 传入数量,获取字符串形式
	 * @Description: 例如：num=1 返回 '00002'
	 * @Author M.Mu
	 * @Date 2020-06-01 04:43:36
	 */
	public static String getStringByInt(Integer num) {
		if (num != null && num > 0) {
			...
			return df.format(Integer.parseInt(i));
		} else {
			return "00001";
		}
	}
	 ...
	 * @Description: 将String字符串转换为Integer数组
	 * @Description: 字符串(内只能包含逗号) 例如：1,2,3
	 * @Author M.Mu
	 * @Date 2020-12-18
	 */
	public static Integer[] stringToIntArr(String str) {
		String[] aaaa = str.split(",");
		Integer[] intArr = new Integer[aaaa.length];
		for (int i = 0; i < aaaa.length; i++) {
			intArr[i] = Integer.valueOf(aaaa[i]);
		}
